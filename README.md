...
- Cursor CLI (`agent`), OpenCode, Codex CLI, Claude Code, Google Antigravity
  CLI (`agy`), Pi, and GitHub Copilot CLI are preinstalled for the unprivileged
  `agent` user;
...
minutes while DNF installs the baseline, the seven coding agents, and the shared
